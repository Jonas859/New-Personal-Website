            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list grid">
                        ...
                        <li class="nav__item">
                            <a href="certicications.php" class="nav__link active-link">
            ...
            <section class="certification section" id="certifications">
                ...
                <div class="certification__container container grid">
                    ...
                    <div class="certification__content">
                        <div>
                            <img src="assets/img/certifications/1.jpg" class="certification__img_1">
                        </div>

                        <a class="button button--flex button--small button--link certification__button"
                            href="assets/img/certifications/1.jpg" target="_blank">
                            View Certificate
                    ...
                    <div class="certification__content">
                        <div>
                            <img src="assets/img/certifications/2.jpg" class="certification__img">
                        </div>

                        <a class="button button--flex button--small button--link certification__button"
                            href="assets/img/certifications/2.jpg"
                            target="_blank">
                            View Certificate
                            <i class="uil uil-arrow-right button__icon"></i>
                        </a>
